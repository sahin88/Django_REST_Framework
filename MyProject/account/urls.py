...
from .views import (GenericAPIViews, LoginView, LogoutView, alist, adetail, registration, verifyEmail,
                    resetPasswordRequestEmail, ArticleListCreateView, passwordRequestEmailVerify, setNewPassword,)
